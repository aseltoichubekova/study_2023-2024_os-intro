...
Для использования графического интерфейса запускаю менеджер виртуальных машин VirtualBox на своей технике. Создаю новую виртуальную машину, указывая имя виртуальной машины как свой логин в дисплейных классах, указывааю тип операционной системы-Linux,Fedora.Указываю размер основной памяти виртуальной машины 2048 МБ.
...
Без изменений оставляю часовой пояс, расладку клавиатуры (рис. [-@fig:013]), а также место установки ОС (рис. [-@fig:014]).
...
## Настройка раскладки клавиатуры 
 ...
 Переключаюсь на роль супер пользователя и редактирую конфигурационный файл /etc/x11/xorg.conf.d/00-keyboard.conf. 
